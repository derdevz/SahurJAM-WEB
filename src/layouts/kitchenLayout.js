export const KITCHEN_LAYOUT = [
  ...
  { type: "diningTable", x: 720, y: 308, w: 112, h: 78, options: { label: "Masa 1", tableId: "table-1" } },
  { type: "diningTable", x: 852, y: 308, w: 112, h: 78, options: { label: "Masa 2", tableId: "table-2" } },
  ...
  { type: "trash", x: 860, y: 528, w: 64, h: 48, options: { label: "Çöp 1" } },
  { type: "trash", x: 936, y: 528, w: 64, h: 48, options: { label: "Çöp 2" } }
];
